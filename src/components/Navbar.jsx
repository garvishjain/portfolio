...
function Navbar() {
    ...
    return (
        <>  
            <nav className="bg-gray-900 text-white px-6 py-6 fixed top-0 left-0 w-full z-50 shadow-md">
                <div className="flex items-center justify-between">
                    ...
                    <ul className="hidden md:flex items-center gap-10">
                        ...
                        <Link to="skills" smooth={true} duration={500} offset={-50} spy={true} activeClass="text-yellow-400">Skills</Link>
                        <Link to="contacts" smooth={true} duration={500} offset={-50} spy={true} activeClass="text-yellow-400">Contact</Link>
                    </ul>
